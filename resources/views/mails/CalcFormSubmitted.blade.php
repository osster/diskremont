...
<body class="clean-body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #DDDDDD">
...
<table class="nl-container"
       style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #DDDDDD;width: 100%"
    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" style="background-color: #DDDDDD;"><![endif]-->
                                        ...
                                        <tr style="vertical-align: top">
                                            <td class="divider_inner"
                                                ...
                                                <table class="divider_content" height="0px" align="center" border="0"
                                                       ...
                                                       style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;border-top: 11px solid #E24B4B;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%">
                                                    <tbody>
                                                    <tr style="vertical-align: top">
                                        ...
                                        <div style="color:#555555;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 30px; padding-top: 10px; padding-bottom: 5px;">
                                            <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px"><strong><span
                                                                style="font-size: 24px; line-height: 28px;">Новый заказ с сайта,</span></strong>
                                                </p>
                                                <table style="width:320px; margin: 30px auto; font-size: 16px; line-height: 20px;">
                                                    <tr style="border-bottom:1px solid #666;">
                                                        <th>Цвет авто</th>
                                                        <td style="text-align: right">{{$data["car_color"]}}</td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid #666;">
                                                        <th>Цвет дисков</th>
                                                        <td style="text-align: right">{{$data["disk_color"]}}</td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid #666;">
                                                        <th>Размер дисков</th>
                                                        <td style="text-align: right">{{$data["disk_size"]}}</td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid #666;">
                                                        <th>Нужна полировка</th>
                                                        <td style="text-align: right">{{$data["disk_polished"] ? "Да" : "Нет"}}</td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid #666;">
                                                        <th>Нужен шиномонтаж</th>
                                                        <td style="text-align: right">{{$data["tire_mount"] ? "Да" : "Нет"}}</td>
                                                    </tr>
                                                    <tr style="border-bottom:1px solid #666;">
                                                        <th>Цена, рублей</th>
                                                ...
                                                <p style="margin: 0;font-size: 14px;line-height: 17px"><span
                                                            style="font-size: 14px; line-height: 16px;"><span
                                                                style="line-height: 16px; font-size: 14px;">Пожалуйста перезвоните посетителю <strong>{{$data["client_name"]}}</strong> по номеру <strong><a href="tel:{{$data["client_phone"]}}">{{$data["client_phone"]}}</a></strong></span></span>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                            ...
                                            <tr>
                                                <td style="padding-right: 10px; padding-left: 30px; padding-top:10px; padding-bottom:10px;"
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:25pt; v-text-anchor:middle; width:84pt;"
                                                                 arcsize="9%" strokecolor="#E24B4B" fillcolor="#E24B4B">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0,0,0,0">
                                                            <center style="color:#ffffff; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px;">
                                        <![endif]-->
                                        <div style="color: #ffffff; background-color: #E24B4B; border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px; max-width: 113px; width: 73px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none;">
                                            <a href="//diskremont.ru" style="font-size:12px;line-height:24px;color:#fff;text-decoration: none;">Перейти на сайт</a>
                                        </div>
                                        ...
                                        <div style="color:#555555;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:180%; padding-right: 30px; padding-left: 30px; padding-top: 30px; padding-bottom: 30px;">
                                            <div style="font-size:12px;line-height:22px;color:#555555;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 22px"><span
                                                            style="font-size: 14px; line-height: 25px;">Если вы не ожидали этого письма или письмо пришло по ошибке просто удалите его.</span>
                                                </p>
                                                <p style="margin: 0;font-size: 12px;line-height: 22px"><span
                                                            style="font-size: 14px; line-height: 25px;">С уважением,</span>
                                                </p>
                                                <p style="margin: 0;font-size: 12px;line-height: 22px"><em><strong><span
                                                                    style="font-size: 14px; line-height: 25px;">команда DISKREMONT.RU</span></strong></em>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                        ...
                                        <div style="color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 5px; padding-left: 5px; padding-top: 5px; padding-bottom: 5px;">
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                    <span style="font-size: 14px; line-height: 16px;"><strong>(812) 970-7-958<br>(812) 972-0-666 </strong></span>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                ...
                                <div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                    ...
                                    <div class="">
                                        ...
                                        <div style="color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 14px;line-height: 17px;text-align: center">
                                                    <span style="font-size: 14px; line-height: 16px;"><strong>info@diskremont.ru</strong></span><br>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
                                            ...
                                            <table width="57" cellpadding="0" cellspacing="0" border="0">
                                                <tr>
                                                    <td style="border-collapse:collapse; padding-right: 0px; padding-left: 0px; padding-bottom: 0px;"
                                                        align="center">
                                                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                                               style="border-collapse:collapse; mso-table-lspace: 0pt;mso-table-rspace: 0pt; width:57px;">
                                                            <tr>
                                        ...
                                        <div style="color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 0px; padding-bottom: 10px;">
                                            <div style="font-size:12px;line-height:14px;color:#FFFFFF;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;text-align:left;">
                                                <p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center">
                                                    <strong><span style="font-size: 14px; line-height: 16px;">Мы в Instagram</span></strong><br>
                                                </p></div>
                                        </div>
                                        <!--[if mso]></td></tr></table><![endif]-->
                                    </div>
